...
import ru.romek.db.dao.ProductsMapper;
import ru.romek.db.model.Products;
import ru.romek.db.model.ProductsExample;
import ru.romek.dto.Category;
import ru.romek.dto.Product;
import ru.romek.enums.CategoryType;
import ru.romek.service.CategoryService;
import ru.romek.service.ProductService;
import ru.romek.utils.DbUtils;
import ru.romek.utils.RetrofitUtils;
...
//  Проверка MyBatis
//  Проверяем, что в созданном продукте встали правильные параметры, соответствующие запросу
        ...
        // Проверка MyBatis
        // Проверяем, что в БД среди продуктов с заданными параметрами есть продукт с Id, равным Id созданного продукта.
...
//  Проверка MyBatis
//  Проверяем, что в созданном продукте встали названия, соответствующие запросу
...
//  Проверка MyBatis
//  Проверяем, что в созданном продукте встали цены, соответствующие запросу
...
//  Проверка MyBatis
//  Проверяем, что получен продукт с параметрами, соответствующими запросу
